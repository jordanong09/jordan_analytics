...
Once we have attained the Z score for each area, we will have to filter the area with z score less than the given critical value of [**3.289**](https://r-spatial.github.io/spdep/reference/localG.html). We will then visualise the variable using `tmap`. 
...
Gimap_fixed <- tm_shape(nigeria.gi) +
  ...
  tm_shape(nigeria.gi[nigeria.gi$gstat_fixed < -3.289 | nigeria.gi$gstat_fixed > 3.289,]) +
...
Gimap_fixed_fun <-tm_shape(nigeria.gi) +
  tm_borders(col = "lightgrey", alpha = 0.5) +
  tm_shape(nigeria.gi[nigeria.gi$gstat_fixed_fun < -3.289 | nigeria.gi$gstat_fixed_fun > 3.289,]) +
...
Gimap_adaptive <-tm_shape(nigeria.gi) +
  tm_borders(col = "lightgrey", alpha = 0.5) +
  tm_shape(nigeria.gi[nigeria.gi$gstat_adaptive < -3.289 | nigeria.gi$gstat_adaptive > 3.289,]) +
...
Gimap_adaptive_fun <-tm_shape(nigeria.gi) +
  tm_borders(col = "lightgrey", alpha = 0.5) +
  tm_shape(nigeria.gi[nigeria.gi$gstat_adaptive_fun < -3.289 | nigeria.gi$gstat_adaptive_fun > 3.289,]) +
