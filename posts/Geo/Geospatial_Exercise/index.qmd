...
Visualising of distribution using funModeling

```{r}
freq(nigeriaT_sf$status)
```
...
nigeria$abandon <- lengths(st_intersects(nigeria, nigeriaT_sf[nigeriaT_sf$status != "Abandoned",]))
