...
Next, we will set a statistical significance level ($\alpha$) for the local Moran. (can be 0.05, 0.01 or 0.001)

```{r}
signif <- 0.05       
```

We will then define the quadrant based on the following criteria:
